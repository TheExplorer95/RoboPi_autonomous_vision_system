...
if __name__ == '__main__':
    try:
        ...
        while True:
            ...
            print(f'Side left - {US.sensor_side_left.distance} m')
            print(f'Side right - {US.sensor_side_right.distance} m')
            print(f'Back left - {US.sensor_back_left.distance} m')
            print(f'Back right - {US.sensor_back_right.distance} m')
